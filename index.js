...
app.get('/nfce/:chaveAcesso', async (req, res) => {
  try {
    const { chaveAcesso } = req.params;

    const urlNfce = `http://nfe.sefaz.go.gov.br/nfeweb/sites/nfce/d/danfeNFCe?p=${chaveAcesso}%7C2%7C1%7C1%7Ce98ec3edfae819032a5b9514508e8c2383066480`;
